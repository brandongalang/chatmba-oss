...
Applicants should know where their data lives. Local use stores data in SQLite on the user's machine. Hosted scholarship deployments must clearly disclose retention, access, and deletion policies.
